...
SVC_TIMER:
	...
	@ Adjust the countdown value in the ascii string by decrementing after 9 snt
	LDR R6, =NINE_SENT
	LDR R5, [R6]
	CMP R5, #0x1
	SUBEQ R3, R3, #0x01
	STREQB R3, [R2] @ store decremented countdown value
	
	MOVNE R5, #0x01 
	STRNE R5, [R6]	@ Set flag indicating nine has been sent
